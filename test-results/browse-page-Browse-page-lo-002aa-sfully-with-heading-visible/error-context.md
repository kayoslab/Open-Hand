...
- Name: browse-page.spec.ts >> Browse page >> loads successfully with heading visible
- Location: tests/e2e/browse-page.spec.ts:4:3
...
Locator: getByRole('heading', { name: /browse/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /browse/i })

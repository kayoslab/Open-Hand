...
- Name: browse-page.spec.ts >> Browse page responsive layout >> mobile card readability (375px) >> card text is visible on mobile
- Location: tests/e2e/browse-page.spec.ts:68:5

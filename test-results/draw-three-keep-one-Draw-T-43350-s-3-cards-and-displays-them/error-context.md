...
- Name: draw-three-keep-one.spec.ts >> Draw Three Keep One >> draws 3 cards and displays them
- Location: tests/e2e/draw-three-keep-one.spec.ts:14:3
...
Locator: getByRole('button', { name: /draw/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /draw/i })

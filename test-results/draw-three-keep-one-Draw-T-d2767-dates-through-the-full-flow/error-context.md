...
- Name: draw-three-keep-one.spec.ts >> Draw Three Keep One >> remaining count updates through the full flow
- Location: tests/e2e/draw-three-keep-one.spec.ts:84:3
...
Call log:
  ...
  - waiting for getByText(/remaining/i)

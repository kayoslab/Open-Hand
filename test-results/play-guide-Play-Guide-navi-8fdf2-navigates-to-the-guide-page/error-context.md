...
- Name: play-guide.spec.ts >> Play Guide navigation >> Guide link in nav navigates to the guide page
- Location: tests/e2e/play-guide.spec.ts:56:3
...
Locator: getByRole('navigation').getByRole('link', { name: /guide/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('navigation').getByRole('link', { name: /guide/i })

...
- Name: play-guide.spec.ts >> Play Guide page >> displays tier indicators with text labels
- Location: tests/e2e/play-guide.spec.ts:45:3
...
Locator: getByText(/working/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/working/i).first()

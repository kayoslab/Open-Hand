...
- Name: play-guide.spec.ts >> Play Guide readability at desktop (1280px) >> headings are readable (visible and non-empty)
- Location: tests/e2e/play-guide.spec.ts:94:5

...
- Name: responsive-shell.spec.ts >> Navigation keyboard accessibility >> navigation links are keyboard-focusable with visible focus indicators
- Location: tests/e2e/responsive-shell.spec.ts:42:3
